...
sed -i '' "s/$duckdb_rs_version/$duckdb_version/g" Cargo.toml crates/duckdb/Cargo.toml crates/libduckdb-sys/upgrade.sh crates/libduckdb-sys/Cargo.toml .github/workflows/rust.yaml
